<nav x-data="{ open: false }" class="bg-sky-600 border-b border-gray-100">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo  lo cambio despues -->
                ...
                <!-- Navigation Links       asegurate de ponerlo con . si no no lo chapa -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                @if (Auth::user()->Usertype->name === 'alumno')
                    <x-nav-link :href="route('alumno.dashboard')" :active="request()->routeIs('alumno.dashboard')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                @elseif(Auth::user()->Usertype->name === "profesor")
